...
pub(super) fn get_by_function(object: &Object, prop_name: &str, property: &Property) -> Func {
    ...
    let mut block = Block::new(&format!("obj.{}(|value| ", snake_case(prop_name)));
...
pub(super) fn getter(object: &Object, prop_name: &str, property: &Property) -> Func {
    ...
    func.extern_abi("C")
        ...
        .line("let str_: *const c_char = value.as_ptr() as *const c_char;")
        .line("set(prop, str_, to_c_int(value.len()));");
...
pub(super) fn qbytearray_setter(object: &Object, prop_name: &str) -> Func {
    ...
    func.extern_abi("C")
        ...
        .line(format!("obj.set_{}(value)", snake_case(prop_name)));
...
pub(super) fn qstring_setter(object: &Object, prop_name: &str) -> Func {
    ...
    func.extern_abi("C")
        ...
        .line(format!("obj.set_{}(s);", snake_case(prop_name)));
